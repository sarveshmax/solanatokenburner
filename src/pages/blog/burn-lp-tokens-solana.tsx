...
export default function BurnLPTokensGuide() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 text-gray-100">
      ...
      <p className="mb-6">
        LP tokens on Solana represent your share in a liquidity pool. Sometimes projects or
        owners need to burn LP tokens permanently — either to lock liquidity, prevent rug
        risks, or reduce supply. This guide explains how to burn any LP tokens including
        Raydium, Orca, Meteora, Crema and all SPL-based LP tokens.
      </p>

      <h2 className="text-2xl font-semibold mt-10 mb-4">🔥 Why Burn LP Tokens?</h2>
      ...
      <p className="mb-4">
        LP tokens are just SPL tokens, so they can be burned the same way regular SPL tokens
        are burned — using SolTokenBurner.
      </p>

      <h3 className="text-xl font-semibold mb-3">1. Open SolTokenBurner</h3>
      <p className="mb-4">Go to https://soltokenburner.com/ and connect your Phantom wallet.</p>
      ...
      <p className="mb-4">
        LP tokens usually appear with random characters like 'jhThdYst' or names like RAY-LP, ORCA-LP, POOL-LP, etc.
      </p>

      <h3 className="text-xl font-semibold mb-3">4. Choose an Option</h3>
      <ul className="list-disc ml-6 mb-4 space-y-1">
        <li><strong>Burn All</strong> — removes the entire LP amount</li>
        <li><strong>Input Amount to Burn</strong> — burns only a specific amount - later you can burn the remaining or pull the liquidity</li>
      </ul>

      <h3 className="text-xl font-semibold mb-3">5. Approve in Wallet</h3>
      <p className="mb-6">
        Once approved, the LP tokens are permanently removed from your wallet and supply. The PadLock will appear on DexScreener now.
      </p>

      <h2 className="text-2xl font-semibold mt-10 mb-4">🔍 How to Verify on Solscan</h2>
